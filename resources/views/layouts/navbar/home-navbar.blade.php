...
<div 
    ...
    <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out">
...
@endauth
@guest
<a href="{{ route('auth') }}" class="hover:text-gray-300 transition duration-300">Login</a>
@endguest
</div>
    </div>
...
@endauth
@guest
<a href="{{ route('auth') }}" class="block py-2 hover:text-gray-300 pt-5">Login</a>
@endguest
