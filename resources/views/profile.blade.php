...
<head>
    ...
    <title>SurabayaAI - User Profile</title>
...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col" x-data="profileApp()">
    <!-- Header -->
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-3/4 md:pl-8">
                            ...
                            <div x-show="activeTab === 'profile'" class="space-y-6">
                                ...
                                <form action="/profile/update" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" value="Dhamar" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-300">
                                    </div>
                                    <div>
                                        <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                        <input type="email" id="email" name="email" value="dhamar@gmail.com" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-300">
                                    </div>
                                    <div>
                                        <label for="bio" class="block text-sm font-medium text-gray-700 mb-1">Bio</label>
                                        <textarea id="bio" name="bio" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-300">Saya tertarik dengan sejarah Surabaya dan ingin mempelajari lebih banyak tentang kota pahlawan ini.</textarea>
                                    </div>
                                    <div>
                            ...
                            <div x-show="activeTab === 'preferences'" class="space-y-6">
                                ...
                                <form action="/profile/preferences" method="POST" class="space-y-4">
                                    @csrf
                                    <div>
    ...
    <div 
        ...
        <div 
            ...
            <form action="/profile/delete" method="POST" class="mb-6">
