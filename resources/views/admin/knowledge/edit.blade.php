@extends('layouts.admin', [
    'title' => 'Edit Entri Pengetahuan',
    'subtitle' => 'Perbarui entri dalam basis pengetahuan'
])

@section('content')
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6 bg-white border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Edit Entri Pengetahuan: {{ $knowledge->topic }}</h2>
        ...
        <form method="POST" action="{{ route('admin.knowledge.update', $knowledge) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="topic" id="topic" value="{{ old('topic', $knowledge->topic) }}" required
            ...
            <div class="mb-6">
                ...
                <input type="text" name="keywords" id="keywords" value="{{ old('keywords', implode(', ', $knowledge->keywords)) }}" required
            ...
            <div class="mb-6">
                ...
                <textarea name="response" id="response" rows="10" required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 @error('response') border-red-500 @enderror">{{ old('response', $knowledge->response) }}</textarea>
                @error('response')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $knowledge->is_active) ? 'checked' : '' }}
