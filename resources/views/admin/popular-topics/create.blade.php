@extends('layouts.admin', [
    'title' => 'Tambah Topik Populer',
    'subtitle' => 'Tambahkan topik populer baru untuk ditampilkan di halaman chat'
])

@section('content')
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6 bg-white border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Tambah Topik Populer Baru</h2>

        <form method="POST" action="{{ route('admin.popular-topics.store') }}">
            @csrf

            <div class="mb-6">
                <label for="display_text" class="block text-sm font-medium text-gray-700 mb-1">Teks Tampilan</label>
                <input type="text" name="display_text" id="display_text" value="{{ old('display_text') }}" required
            ...
            <div class="mb-6">
                ...
                <input type="number" name="order" id="order" value="{{ old('order', \App\Models\PopularTopic::count() + 1) }}" required min="1"
