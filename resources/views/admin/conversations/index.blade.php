@extends('layouts.admin', [
    ...
    'subtitle' => 'Kelola semua percakapan pengguna dengan SurabayaAI'
])
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6 bg-white border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.conversations.statistics') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300">
            Lihat Statistik
        </a>
    </div>
    ...
    <div class="p-6">
        @include('components.admin.search-form', [
            ...
            'placeholder' => 'Cari judul, pengguna, atau isi pesan...',
            'filters' => '
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Pesan</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="text-xs text-gray-400">{{ $conversation->session_id }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.conversations.show', $conversation) }}" class="text-blue-600 hover:text-blue-900">Lihat</a>
