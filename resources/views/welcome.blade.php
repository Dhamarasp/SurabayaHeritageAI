...
<body class="bg-white text-gray-800">
    ...
    <header class="fixed top-0 left-0 w-full z-50 bg-gray-800 text-white shadow-md">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <label for="menu-toggle" class="cursor-pointer md:hidden transition-transform duration-300">
            ...
            <nav class="hidden md:flex space-x-6">
                ...
                <a href="#examples" class="hover:text-gray-300 transition duration-300">Examples</a>
    ...
    <section id="features" class="py-20 bg-gray-200">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-16 fade-in">Why Choose SurabayaAI?</h2>
    ...
    <section id="how-it-works" class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-16 fade-in">How SurabayaAI Works</h2>
            <div class="flex flex-col lg:flex-row items-center justify-between">
                <div class="w-full lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
                    <div class="bg-white p-6 rounded-lg shadow-md mb-8 transition-all duration-300 hover:shadow-lg fade-in">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg fade-in">
                        <div class="flex items-center mb-4">
                    ...
                    <div class="bg-gray-100 rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl max-w-md mx-auto lg:max-w-full">
                        ...
                        <div class="p-6 bg-gray-100 h-80 overflow-y-auto">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 shadow-sm transform transition-transform duration-300 hover:-translate-y-1">
                                <p class="text-gray-800"><span class="font-semibold text-gray-800">SurabayaAI:</span> <span class="typing-container"><span class="typing-text">The Battle of Surabaya took place on November 10, 1945. It was a fight between Indonesian nationalists and British-Indian troops as part of the Indonesian National Revolution.</span></span></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="try-now" class="py-20 bg-gray-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-8 fade-in">Experience SurabayaAI Now</h2>
            <p class="text-xl mb-10 max-w-3xl mx-auto fade-in">Ask your first question about Surabaya's history and discover the power of AI-driven historical knowledge.</p>
    ...
    <section id="examples" class="py-20 bg-gray-200">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-16 fade-in">Popular Questions About Surabaya</h2>
    ...
    <section class="py-20 bg-gray-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-6 fade-in">Ready to Explore Surabaya's History?</h2>
            <p class="text-xl mb-10 max-w-3xl mx-auto fade-in">Join thousands of users who are discovering the fascinating stories of Surabaya through our AI-powered platform.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            typingTexts.forEach(text => {
                text.style.width = '0';
                setTimeout(() => {
                    text.style.animation = 'typing 3.5s steps(40, end) forwards, blink-caret 0.75s step-end infinite';
                }, 1000);
            });
